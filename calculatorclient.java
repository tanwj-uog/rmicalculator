...
public class calculatorclient {
    ...
    public static void main(String[] args) {
       System.setProperty("java.rmi.server.hostname", "219.75.45.35"); // My desktop external IP

      //use localhost if running the server locally or use IP address of the server
       String reg_host = "52.149.157.162"; //Azure vm ip
       int reg_port = 1099;
	...
	try {
		...
		calculator c = (calculator)Naming.lookup("rmi://52.149.157.162:1099/CalculatorService");
     


	    // Now use the reference c to call remote methods
		System.out.println("1+1=" + c.add(1, 1));
		System.out.println("10-5=" + c.sub(10, 5));
